...
class TestPretrainDiffusionFlag(unittest.TestCase):
    ...
    def test_pretrain_enabled(self, mock_config, mock_diffusion, mock_hier, mock_prepare, mock_trainer):
        cfg = Config()
    ...
    @patch('scripts.train.DiffusionModel')
    @patch('scripts.train.Config')
    def test_pretrain_disabled(self, mock_config, mock_diffusion, mock_hier, mock_prepare, mock_trainer):
        cfg = Config()
        cfg.use_diffusion = True
